...
export const LANGUAGES = [
    ...
    // Data Science & AI
    {
        ...
        icon: Database, // Generic fallback
        color: 'text-purple-500',
        bg: 'bg-purple-500/10',
    ...
    },
    {
        ...
        description: 'Study of computer algorithms that improve automatically.'
    },
    {
        id: 'ai',
    ...
    },
    {
        ...
        category: 'Game Dev',
        icon: Ghost, // Using Ghost as placeholder or generic
    ...
    },
    {
        ...
        slug: 'cs',
        category: 'Education',
        icon: BookOpen, // Needs import
        color: 'text-blue-600',
        bg: 'bg-blue-600/10',
        description: 'Theory of computation and information.'
    },
    {
        id: 'certification',
        name: 'Certification',
