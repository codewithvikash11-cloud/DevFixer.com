                ...
                <div className="container mx-auto px-4 max-w-5xl">
                    ...
                    <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <h1 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight">
                            Developer <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">Toolkit</span>
                        </h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="group relative bg-[#0f172a] border border-[#334155] rounded-3xl p-8 hover:border-blue-500/50 transition-all duration-300">
                            ...
                            <div className="relative z-10">
                                ...
                                <button className="w-full py-3 bg-[#1e293b] hover:bg-blue-600 text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 group-hover:bg-blue-600">
                        ...
                        <div className="group relative bg-[#0f172a] border border-[#334155] rounded-3xl p-8 hover:border-green-500/50 transition-all duration-300">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-4 mb-8">
                                    ...
                                    <div className="flex items-center gap-3 text-sm text-gray-500">
                                        <div className="w-4 h-4 rounded bg-blue-500/20 border border-blue-500/50 flex items-center justify-center text-[8px] font-bold text-blue-500">KW</div> Keyword Cloud
                                    </div>
                                    <div className="flex items-center gap-3 text-sm text-gray-500">
