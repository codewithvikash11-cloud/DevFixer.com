    ...
    return (
        <div className={cn("flex items-center gap-3 group select-none cursor-pointer", className)}>
            ...
            <div className="relative w-9 h-9 flex items-center justify-center">
                ...
                <div className="absolute inset-0 bg-[#00FF88] rounded-full blur-xl opacity-20 group-hover:opacity-40 animate-pulse transition-opacity duration-500"></div>
                ...
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full relative z-10 transition-transform duration-500 group-hover:rotate-180">
                    <defs>
                        <linearGradient id="orbitGradient" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
                            ...
                            <stop offset="100%" stopColor="#00E67A" />
                        </linearGradient>
                    </defs>
                    ...
                    <circle cx="20" cy="20" r="5" fill="#00FF88" className="drop-shadow-[0_0_8px_#00FF88]" />
                </svg>
            </div>
            ...
            {!iconOnly && (
                <div className="flex flex-col">
                    <span className="text-xl font-black tracking-tight text-text-primary leading-none">
                        Dev<span className="text-[#00FF88]">Fixer</span>
                    </span>
                </div>
            )}
        </div>
